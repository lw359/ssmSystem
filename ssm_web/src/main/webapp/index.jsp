...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=traderefund action="/alipay.trade.refund.jsp" method=post target="_blank">
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDout_trade_no").value ='${param.name}'//"aa";
		document.getElementById("WIDsubject").value = "测试";
		document.getElementById("WIDtotal_amount").value ='${param.price}';//100;
	}
	GetDateNow();
</script>
</html>